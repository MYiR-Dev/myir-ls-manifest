...
or for mydj1028:
$ mkdir myir-real-time-edge
$ cd myir-real-time-edge
$ repo init -u https://github.com/MYiR-Dev/myir-ls-manifest.git -m myir-mydj1028-5.10.9-1.0.0.xml
...
for mydj1028:
$ DISTRO=nxp-real-time-edge MACHINE=mydj1028 source real-time-edge-setup-env.sh -b build-mydj1028-real-time-edge
```
